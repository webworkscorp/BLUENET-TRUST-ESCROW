  ...
  return (
    <section id="agendar" className="relative py-24 reveal overflow-hidden bg-transparent">
      <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-12 text-center">
        <h2 className="text-brand-accent text-xs font-black uppercase tracking-[0.3em] mb-4 drop-shadow-sm">{t('form.tag')}</h2>
        <h3 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6 tracking-tight drop-shadow-md">{t('form.title')}</h3>
