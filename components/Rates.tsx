...
const Rates: React.FC = () => {
  return (
    <section id="tarifas" className="relative py-24 md:py-32 overflow-hidden bg-brand-primary">
      {/* Background Image Container - High Sharpness */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Subtle dark gradient overlay to ensure text legibility without a white "wall" */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-black/40"></div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-20">
          <h3 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6 drop-shadow-md">TARIFAS DE SERVICIO</h3>
          ...
          {RATES.map((rate, index) => (
            ...
            >
              ...
              <ul className="space-y-4 mb-10">
                {rate.features.map((feature, fIndex) => (
        ...
        <p className="text-center mt-12 text-[11px] text-gray-200 uppercase tracking-widest font-black max-w-2xl mx-auto leading-relaxed drop-shadow-sm italic">
          (Cualquier gasto adicional será asumido completamente por el cliente)
        </p>
      </div>
    </section>
  );
